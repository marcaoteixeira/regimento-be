...
class Conteudo{
    ...
    async ConteudoSave(id_bloco, id_tipo, id_titulo,id_capitulo, id_secao, id_subsecao, id_artigo, id_paragrafo, id_inciso, id_alinea, conteudo){
        try{                       
            await knex.insert({ id_bloco, id_tipo, id_titulo,id_capitulo, id_secao, id_subsecao, id_artigo, id_paragrafo, id_inciso, id_alinea, conteudo}).table("tab_conteudo");
    ...
    async ConteudoUpdate(id, id_bloco, id_tipo, id_titulo,id_capitulo, id_secao, id_subsecao, id_artigo, id_paragrafo, id_inciso, id_alinea, conteudo){
        try{                       
            await knex.where({id: id}).update({ id_bloco, id_tipo, id_titulo,id_capitulo, id_secao, id_subsecao, id_artigo, id_paragrafo, id_inciso, id_alinea, conteudo}).table("tab_conteudo")
