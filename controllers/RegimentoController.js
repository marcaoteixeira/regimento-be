...
class RegimentoController{
   ...
   async conteudosave(req, res) {
      ...
      var {id_bloco, id_tipo, id_artigo, id_paragrafo, id_inciso, id_alinea, linkartigo, conteudo} = req.body;       
      
      await Conteudo.ConteudoSave(id_bloco, id_tipo, id_artigo, id_paragrafo, id_inciso, id_alinea, linkartigo,  conteudo);
   ...
   async updateconteudo(req, res) {
      ...
      await Conteudo.ConteudoUpdate(id_bloco, id_tipo, id_artigo, id_paragrafo, id_inciso, id_alinea, linkartigo, conteudo);
